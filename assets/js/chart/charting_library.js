!(function (t, e) {
  ...
  function s(t) {
    ...
    return `<link rel="preload" href="${t}" as="font" type="font/woff${
      (e = n == null ? void 0 : n[1]) !== null && void 0 !== e ? e : '2'
    }" crossorigin="anonymous"/>`
  }
  function r(t, e) {
    const n = new URL(`${t || ''}`, location.href).href
    const i = JSON.parse(
      '["bundles/runtime.6b7a1146863d7196d6d3.js","bundles/5386.eb112967859403067d3d.css","bundles/5386.eb112967859403067d3d.rtl.css","bundles/1857.10c97feeb46d934b8a25.js","bundles/library.087f6aeafe9a1f8bd541.js","bundles/b1a63a011fd92dfb93db6db243bb036c.woff2","bundles/40f9a03d174178efb12303caa9bc7cd8.woff2","bundles/3293616ec0c605c7c2db25829a0a509e.woff"]'
    )
    const o = JSON.parse(
    ...
    return `<!DOCTYPE html><html ${
      ...
      h.localeLanguage
    }-tv-locale.f0c7bba9.js" crossorigin="anonymous"><\/script> ${
      h.bundles
  ...
  function a() {
    return 'CL v23.039 (internal id f0c7bba9 @ 2023-01-12T15:05:51.527Z)'
  }
  const d = class {
    constructor(t) {
      let s
      ...
      this._options.theme === 'Dark' &&
        ...
        this._options.debug &&
          (o ||
            ((o = !0),
            console.log(
              'Using CL v23.039 (internal id f0c7bba9 @ 2023-01-12T15:05:51.527Z)'
            ))),
        this._create()
    }
    ...
    _render() {
      ...
      const n = new Blob([e], { type: 'text/html' })
